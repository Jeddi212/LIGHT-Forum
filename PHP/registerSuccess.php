...
<div class="flex-container">
	<?php
		if (isset($_SESSION['username']) || isset($_COOKIE['username'])) {
		    ...
		    echo '<div class="two" style="font-size: 50px;">Registration Success <br>', $_COOKIE['username'],'</div>';
		    echo '<div class="three" style="font-size: 30px;"><a href="forum.php">Let\'s go to The Forum</a></div>';
		} else {
